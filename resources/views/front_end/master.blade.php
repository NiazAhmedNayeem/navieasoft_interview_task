...
<head>
    ...
    <link href="{{'/'}}front_end/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
...
<script src="{{'/'}}front_end/lib/isotope/isotope.pkgd.min.js"></script>
<script src="{{'/'}}front_end/lib/lightbox/js/lightbox.min.js"></script>
